...
ggsave(here::here("figures/main/main_arima_plots.svg"),
       arima_plots,
       width = 15,
       height = 8)
...
ggsave(here::here("figures/main/main_figure_2.png"),
       mf2,
       width = 15,
       height = 8)

ggsave(here::here("figures/main/main_figure_2.svg"),
       mf2,
       width = 15,
       height = 8)
...
```{r main-figure-3}
stringency <- read_csv(here::here("data/stringency_index.csv"))

stringency_2020 <- stringency %>%
        select(-X1, -country_name, iso3 = country_code) %>%
...
ggsave(here::here("figures/main/main_figure_3.png"),
       mf3,
       width = 7,
       height = 12)

ggsave(here::here("figures/main/main_figure_3.svg"),
       mf3,
       width = 7,
       height = 12)
```
...
ggsave(here::here("figures/supplement/supplement1_age_sex_region_notifcations.svg"),
       plot = aggregate_plot,
       width = 10,
       height = 15)
...
ggsave(sf2,
        file = here('figures/supplement/supplement2_forest.png'),
       w = 10,
       h = 7)

ggsave(sf2,
        file = here('figures/supplement/supplement2_forest.svg'),
       w = 10,
       h = 7)
...
ggsave(sf3,
        file = here('figures/supplement/supplement3_map.png'),
       w = 10,
       h = 7)

ggsave(sf3,
        file = here('figures/supplement/supplement3_map.svg'),
       w = 10,
       h = 7)
...
ggsave(here::here("figures/supplement/supplement4_age_region_annual_change.svg"),
       plot = diff_plot)
